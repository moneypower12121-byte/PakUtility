  ...
  return (
    <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
      ...
      <div className="prose prose-emerald max-w-none text-gray-600 leading-relaxed space-y-4">
        <p>Welcome to <strong>PakUtilityTools</strong>. This page outlines our {title.toLowerCase()} which governs the use of our services.</p>
        
        <h2 className="text-xl font-bold text-gray-800 mt-6">Overview</h2>
        <p>PakUtilityTools is an independent utility tools provider. We aim to offer free and accessible calculators for the people of Pakistan. Our tools include electricity bill estimators, tax calculators, and more.</p>
        ...
        <p>If you have questions regarding this {title.toLowerCase()}, please contact us via our official support channels at support@pakutilitytools.xyz.</p>
