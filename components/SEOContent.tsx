...
const SEOContent: React.FC = () => {
  return (
    <section className="mt-16 prose prose-emerald max-w-none bg-white p-8 rounded-xl shadow-sm border border-gray-100">
      <h2 className="text-2xl font-bold text-gray-800 mb-4">Why Use PakUtilityTools?</h2>
      <p className="text-gray-600 leading-relaxed mb-4">
        Navigating the complexities of utility bills, taxes, and religious obligations in Pakistan can be challenging. <strong>PakUtilityTools</strong> is designed as a one-stop digital hub providing smart calculators to simplify these tasks for citizens. Whether you are a salaried individual checking your <strong>FBR Salary Tax</strong> for the new fiscal year or a homeowner estimating your monthly <strong>LESCO or IESCO bill</strong>, we provide accurate, data-driven estimates at your fingertips.
      </p>
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <h3 className="text-xl font-semibold mb-2 text-emerald-800">100% Legal & Data-Secure</h3>
          <p className="text-gray-600">
            We prioritize your privacy. Unlike other platforms, PakUtilityTools never accesses private government databases like NADRA or PTA. All validations, such as our <strong>CNIC Format Checker</strong>, rely purely on mathematical algorithms and public logic without storing any personal user data.
          </p>
        </div>
        <div>
